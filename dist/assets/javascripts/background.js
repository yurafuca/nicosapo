...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comuHolder = __webpack_require__(3);
	...
	var comuHolder = new _comuHolder.ComuHolder();
	var newArrival = new _newArrival.NewArrival();
	var broadcastTabs = [];
	...
	var Account = function () {
	    ...
	    _createClass(Account, null, [{
	        ...
	        value: function isLogined() {
	            return _nicovideo.Napi.isLogined();
	        }
	    }]);
	...
	function loadCasts(liveType) {
	    return new Promise(function (resolve, reject) {
	        ...
	        if (liveType == 'user') {
	            _nicovideo.Napi.getSubscribe_2().then(function ($videoInfos) {
	        ...
	        if (liveType == 'official') {
	            ...
	            _nicovideo.Napi.getOfficialOnair().then(function (official_lives) {
	...
	(0, _jquery2.default)(function () {
	    ...
	    _nicovideo.Napi.getSubscribe_2();
	...
	function refresh() {
	    ...
	    _nicovideo.Napi.getCheckList().then(function (idList) {
	...
	function test(id, storagedData) {
	    return new Promise(function (resolve) {
	        ...
	        _nicovideo.Napi.isOffAir(id).then(function (response) {
	            // ONAIR
	...
	function checkAndOpenFreshCast(id, storagedData) {
	    _nicovideo.Napi.isStartedBroadcast(id).then(function (result) {
	...
	var NewArrival = function () {
	    ...
	    _createClass(NewArrival, [{
	        ...
	        value: function get(infos) {
	            ...
	            var newArrives = $.makeArray();
	            var sourceTimes = $.makeArray();
	            ...
	            $.each(infos, function (index, info) {
	                var targetTime = $(info).find('video open_time_jpstr').text();
	                var result = $.inArray(targetTime, sourceTimes);
	                if (result === -1) {
	...
	var ComuHolder = function () {
	    ...
	    _createClass(ComuHolder, [{
	        ...
	        value: function isNew(info) {
	            ...
	            var id = $(info).find('community id').text();
	            var inarray = $.inArray(parseInt(id), this.source);

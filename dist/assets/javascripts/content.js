...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeCounter = __webpack_require__(7);
	
	var _TimeCounter2 = _interopRequireDefault(_TimeCounter);
	
	var _FormatNicoPage = __webpack_require__(8);
	
	var _FormatNicoPage2 = _interopRequireDefault(_FormatNicoPage);
	...
	var _AutoRedirectButton = __webpack_require__(11);
	...
	var timeCounter = new _TimeCounter2.default(new Date());
	var formatNicoPage = new _FormatNicoPage2.default();
	var idHolder = new _IdHolder2.default();
	
	var autoRedirectButton = new _AutoRedirectButton2.default();
	var autoEnterCommunityButton = new _AutoEnterCommunityButton2.default();
	var autoEnterProgramButton = new _AutoEnterProgramButton2.default();
	...
	(0, _jquery2.default)(function () {
	    ...
	    switch (pageType) {
	        ...
	        case 'MODERN_CAST_PAGE':
	            (0, _jquery2.default)('#player').after(extendedBar);
	            (0, _jquery2.default)('#watch_player_top_box').after(extendedBar);
	            ...
	            _Api2.default.getStatusByBroadcast(idHolder.liveId).then(function (response) {
	                ...
	                var endTime = Number((0, _jquery2.default)(response).find('stream end_time').text() + '000');
	                var endDate = new Date(endTime);
	
	                var endTimeJpn = _Time2.default.toJpnString(endDate.getTime());
	
	                var restTime_Minute = _Time2.default.minuteDistance(currentDate, endDate);
	                var restTime_Second = _Time2.default.minuteDistanceOfSec(currentDate, endDate);
	                ...
	                (0, _jquery2.default)('#extended-bar .end-time').text("" + endTimeJpn);
	                (0, _jquery2.default)('#extended-bar .rest-time').text(restTime_Minute + "\uFF1A" + restTime_Second);
	            });
	            break;
	        case 'STAND_BY_PAGE':
	            chrome.runtime.sendMessage({
	    ...
	    setInterval(function () {
	        var $restTime = (0, _jquery2.default)('#extended-bar .rest-time');
	        if ($restTime.text() == '放送が終了しました') {
	            // TODO: Too Ugly.
	            return;
	        }
	        var minute = timeCounter.getMinute();
	        var second = timeCounter.getSecond();
	...
	(0, _jquery2.default)(function () {
	    (0, _jquery2.default)(document).on('click', '.auto_redirect_button', function () {
	    ...
	    (0, _jquery2.default)(document).on('click', '.auto_enter_program_button', function () {
	    ...
	    (0, _jquery2.default)(document).on('click', '.auto_enter_community_button', function () {
	...
	function autoRedirect() {
	    if (autoRedirectButton.isToggledOn()) {
	        ...
	        _Log2.default.out(idHolder.liveId + ' is enabled auto redirect.');
	        ...
	        _Api2.default.isOffAir(idHolder.liveId).then(function (response) {
	            ...
	            if (!response.isOffAir) {
	                ...
	                var endTimeJpn = _Time2.default.toJpnString(endDate.getTime());
	                var endTimeJpnLast = (0, _jquery2.default)('#extended-bar .end-time').text();
	                ...
	                if (endTimeJpnLast !== endTimeJpn) {
	                    ...
	                    var _loop = function _loop(i) {
	                        ...
	                        setTimeout(function () {
	                            (0, _jquery2.default)('#extended-bar .message').text(message);
	                        }, i * 500);
	                    };
	            ...
	            // OFFAIR.
	            _Api2.default.isStartedBroadcast(idHolder.communityId).then(function (response) {
	                // タイマーを無効化
	                (0, _jquery2.default)('#extended-bar .end-time').text("\u653E\u9001\u304C\u7D42\u4E86\u3057\u307E\u3057\u305F");
	                (0, _jquery2.default)('#extended-bar .rest-time').text("\u653E\u9001\u304C\u7D42\u4E86\u3057\u307E\u3057\u305F");
	
	                _Log2.default.out('Napi.isStartedBroadcast', response);
	        ...
	        _Log2.default.out(idHolder.liveId + ' is disabled auto redirect.');
	    }
	...
	function redirectBroadcastPage(broadcastId) {
	    var endpoint = 'http://live.nicovideo.jp/watch/';
	    var broadcastUrl = endpoint + broadcastId;
	    window.location.replace(broadcastUrl);
	}
	
	function isEnabledAutoRedirect() {
	    var data = sessionStorage[idHolder.communityId];
	    ...
	    if (parsedData.enabledAutoRedirect == 'false') return false;
	}
	    ...
	    _createClass(Napi, [{
	        ...
	        value: function isLogined() {
	            var promise = new Promise(function (resolve, reject) {
	                var posting = _jquery2.default.post("http://www.nicovideo.jp/api/mylistgroup/list", function (response) {
	                    var status = (0, _jquery2.default)(response).attr('status');
	                    console.log(status);
	                    switch (status) {
	                        case 'ok':
	                            resolve(true);
	        ...
	        value: function getSessionId() {
	            var promise = new Promise(function (resolve, reject) {
	                var posting = _jquery2.default.post("http://api.ce.nicovideo.jp/api/v1/session.create", {});
	                posting.done(function (data) {
	                    var status = (0, _jquery2.default)(data).find('nicovideo_user_response').attr('status');
	                    switch (status) {
	                        case "ok":
	                            var sessionId = (0, _jquery2.default)(data).find('session').text();
	        ...
	        key: 'loadCasts',
	        value: function loadCasts(liveType) {
	            return new Promise(function (resolve, reject) {
	                console.info('[imanani][Broadcasts.loadAnyBroadcasts] liveType = ', liveType);
	                if (liveType == 'user') {
	                    Napi.getSubscribe_2().then(function ($videoInfos) {
	        ...
	        key: 'getSubscribe',
	        value: function getSubscribe(sessionId) {
	            var promise = new Promise(function (resolve, reject) {
	        ...
	        key: 'getSubscribe_2',
	        value: function getSubscribe_2() {
	            var promise = new Promise(function (resolve, reject) {
	
	                var posting = _jquery2.default.post("http://live.nicovideo.jp/my");
	
	                posting.done(function (response) {
	                    var htmlContent = (0, _jquery2.default)(response);
	                    var subscribes = htmlContent.find("[id$=subscribeItemsWrap] > .liveItems > [class^='liveItem']");
	                    var reserved = htmlContent.find("[id$=subscribeReservedItemsWrap] > .liveItems > [class^='liveItem']");
	
	                    _jquery2.default.each((0, _jquery2.default)(reserved), function (index, item) {
	                        item.is_reserved = true;
	                    });
	
	                    _jquery2.default.merge(subscribes, reserved);
	
	                    var videoInfos = [];
	
	                    _jquery2.default.each((0, _jquery2.default)(subscribes), function (index, item) {
	
	                        var video_title = (0, _jquery2.default)(item).find('a').first().attr('title');
	                        var video_url = (0, _jquery2.default)(item).find('a').first().attr('href');
	                        var video_id = video_url.match(/(lv\d+)/g)[0];
	
	                        var img = (0, _jquery2.default)((0, _jquery2.default)(item).find('img')[0]);
	
	                        if (img.attr('alt') == 'CLOSED') {
	                            return;
	                        }
	
	                        var community_thumbnail_base = img.attr('src').match(/http\:\/\/icon.nimg.jp\/(channel|community)\//)[0];
	                        var community_id = img.attr('src').match(/(ch|co)\d+/)[0];
	                        var community_thumbnail = community_thumbnail_base + community_id + '.jpg';
	
	                        var video_open_time_jpstr = (0, _jquery2.default)(item).find('strong').first().text();
	
	                        var videoInfo = (0, _jquery2.default)('\n                        <video_info>\n                            <video>\n                                <id></id>\n                                <title></title>\n                                <open_time></open_time>\n                                <open_time_jpstr></open_time_jpstr>\n                                <start_time></start_time>\n                                <schedule_end_time/>\n                                <end_time></end_time>\n                                <provider_type>y</provider_type>\n                                <related_channel_id/>\n                                <hidescore_online></hidescore_online>\n                                <hidescore_comment></hidescore_comment>\n                                <community_only></community_only>\n                                <channel_only></channel_only>\n                                <view_counter></view_counter>\n                                <comment_count></comment_count>\n                                <is_panorama></is_panorama>\n                                <_ts_reserved_count></_ts_reserved_count>\n                                <timeshift_enabled></timeshift_enabled>\n                                <is_hq></is_hq>\n                                <is_reserved></is_reserved>\n                            </video>\n                            <community>\n                                <id></id>\n                                <name></name>\n                                <channel_id/>\n                                <global_id></global_id>\n                                <thumbnail></thumbnail>\n                                <thumbnail_small></thumbnail_small>\n                            </community>\n                        </video_info>\n                    ');
	        ...
	        value: function getCheckList() {
	            var promise = new Promise(function (resolve, reject) {
	                var endpoint = "http://flapi.nicovideo.jp/api/getchecklist";
	                var posting = _jquery2.default.get(endpoint);
	                // I dont know why "posting" calls fail(), not done().
	                posting.fail(function (data) {
	                    var text = _jquery2.default.parseJSON(data.responseText);
	                    var status = text.status;
	                    switch (status) {
	                        case "OK":
	                            var checkList = text.community_id;
	                            resolve((0, _jquery2.default)(checkList));
	                            break;
	                        default:
	                            reject(new Error('Request failed: status is "fail".'));
	                            break;
	        ...
	        key: 'getFutureOnair',
	        value: function getFutureOnair(index) {
	            var promise = new Promise(function (resolve, reject) {
	                var endpoint = "http://live.nicovideo.jp/api/getindexzerostreamlist?status=comingsoon&sort=timeshift_reserved_count&zpage=";
	                var posting = _jquery2.default.get(endpoint + index);
	                posting.done(function (response) {
	                    var feature_lives = response['reserved_stream_list'];
	                    if (feature_lives) {
	        ...
	        key: 'getOfficialOnair',
	        value: function getOfficialOnair() {
	            var promise = new Promise(function (resolve, reject) {
	                var endpoint = "http://live.nicovideo.jp/ranking?type=onair&main_provider_type=official";
	                var posting = _jquery2.default.get(endpoint);
	                posting.done(function (response) {
	                    var official_lives = (0, _jquery2.default)(response).find('.ranking_video');
	                    resolve(official_lives);
	                });
	            });
	            return promise;
	        ...
	        value: function getStatus(param) {
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                var parameter = parameter_nicovideojs.shift();
	                posting.done(function (response) {
...
/***/ function(module, exports) {
	...
	var TimeCounter = function () {
	    ...
	    _createClass(TimeCounter, [{
	        key: "addSecond",
	        value: function addSecond(second) {
	        ...
	        key: "subSecond",
	        value: function subSecond(second) {
	            second = parseInt(second);
	            if (this.second === 0) {
	                this.second = 59;
	                this._subMinute(1);
	        ...
	        key: "_subMinute",
	        value: function _subMinute(minute) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormatNicoPage = function () {
	    function FormatNicoPage() {
	        _classCallCheck(this, FormatNicoPage);
	
	        this.$program_icon = (0, _jquery2.default)('.program_icon');
	        this.$program_title = (0, _jquery2.default)('.program-title');
	        this.$watch_title_box_meta = (0, _jquery2.default)('#watch_title_box .meta');
	        this.$slider_container = (0, _jquery2.default)('#slider_container');
	    }
	
	    _createClass(FormatNicoPage, [{
	        key: 'exec',
	        value: function exec(pageType) {
	    ...
	    return FormatNicoPage;
	}();
	
	exports.default = FormatNicoPage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getLiveId() {
	    var url = (0, _jquery2.default)('meta[property="og:url"]').attr('content');
	    var re = /http:\/\/live\.nicovideo\.jp\/watch\/lv([0-9]+)/;
	
	    if (re.exec(url)) {
	        var liveId = 'lv' + re.exec(url)[1];
	        return liveId;
	    }
	...
	function getCommunityId() {
	    var communityUrl1 = (0, _jquery2.default)('meta[property="og:image"]').attr('content');
	    var re1 = /http:\/\/icon\.nimg\.jp\/(community|channel).*((ch|co)[0-9]+)\.jpg.*/;
	
	    // ユーザ放送
	    if (re1.exec(communityUrl1)) {
	        var communityId = re1.exec(communityUrl1)[2];
	        return communityId;
	    }
	
	    var communityUrl2 = (0, _jquery2.default)('a.ch_name').attr('href');
	    var re2 = /http:\/\/(com|ch)\.nicovideo\.jp\/(community|channel)\/([\x21-\x7e]+)/;
	
	    // チャンネル放送/公式放送
	    if (re2.exec(communityUrl2)) {
	        var _communityId = re2.exec(communityUrl2)[3];
	        return _communityId;
	    }
	...
	var IdHolder = function IdHolder() {
	    _classCallCheck(this, IdHolder);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageType = function () {
	    ...
	    _createClass(PageType, null, [{
	        ...
	        key: '_isModernCast',
	        value: function _isModernCast() {
	            var re = /http:\/\/live2\.nicovideo\.jp\/watch\/lv([0-9]+)/;
	        ...
	        key: '_isStandByPage',
	        value: function _isStandByPage() {
	            var flag = (0, _jquery2.default)('#gates').length === 0 && (0, _jquery2.default)('.gate_title').length > 0;
	
	            return flag;
	        }
	    }, {
	        key: '_isGatePage',
	        value: function _isGatePage() {
	            var flag = (0, _jquery2.default)('#gates').length > 0;
	
	            return flag;
	        }
	    }, {
	        key: '_isCommunityPage',
	        value: function _isCommunityPage() {
	            var $targetDom = (0, _jquery2.default)('table.communityDetail');
	        ...
	        key: '_isChannelPage',
	        value: function _isChannelPage() {
	            var $targetDom = (0, _jquery2.default)('body#channel_top');
	        ...
	        key: '_isOfficialCastPage',
	        value: function _isOfficialCastPage() {
	            var $targetDom = (0, _jquery2.default)('#page.official');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoRedirectButton = function (_Buttons) {
	    _inherits(AutoRedirectButton, _Buttons);
	
	    function AutoRedirectButton() {
	        _classCallCheck(this, AutoRedirectButton);
	    ...
	    _createClass(AutoRedirectButton, [{
	        ...
	        value: function _make() {
	            ...
	            // TODO: 別クラスに切り分ける．
	            (0, _jquery2.default)('#watch_title_box .meta').css('overflow', 'visible');
	    ...
	    return AutoRedirectButton;
	}(_Buttons3.default);
	
	exports.default = AutoRedirectButton;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoEnterCommunityButton = function (_Buttons) {
	    _inherits(AutoEnterCommunityButton, _Buttons);
	
	    function AutoEnterCommunityButton() {
	        _classCallCheck(this, AutoEnterCommunityButton);
	    ...
	    _createClass(AutoEnterCommunityButton, [{
	        ...
	        value: function saveAsAutoEnter() {
	            ...
	            var title = void 0; // Required for Both.
	            var openDate = void 0; // Required for Live only.
	            var owner = void 0; // Required for Community only.
	    ...
	    return AutoEnterCommunityButton;
	}(_Buttons3.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoEnterProgramButton = function (_Buttons) {
	    _inherits(AutoEnterProgramButton, _Buttons);
	
	    function AutoEnterProgramButton() {
	        _classCallCheck(this, AutoEnterProgramButton);
	    ...
	    return AutoEnterProgramButton;
	}(_Buttons3.default);
	
	exports.default = AutoEnterProgramButton;

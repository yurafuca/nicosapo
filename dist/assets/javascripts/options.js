...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingPage = function () {
	    ...
	    _createClass(SettingPage, null, [{
	        ...
	        value: function getAllSettings() {
	            ...
	            settings['options.redirect.time'] = (0, _jquery2.default)('#options-redirect-time :selected').val();
	            settings['options.popup.enable'] = (0, _jquery2.default)('input[name=options-popup-enable]:checked').val();
	            settings['options.showReserved.enable'] = (0, _jquery2.default)('input[name=options-showReserved-enable]:checked').val();
	            settings['options.playsound.enable'] = (0, _jquery2.default)('input[name=options-playsound-enable]:checked').val();
	            settings['options.soundfile'] = (0, _jquery2.default)('#options-soundfile :selected').val();
	            settings['options.playsound.volume'] = (0, _jquery2.default)("input[name=options-playsound-volume]").val();
	            settings['options.autoJump.enable'] = (0, _jquery2.default)('input[name=options-autoJump-enable]:checked').val();
	        ...
	        value: function setAllSettings() {
	            ...
	            if (setting != null) (0, _jquery2.default)('#options-redirect-time').val([setting]);
	
	            setting = localStorage.getItem('options.popup.enable');
	            if (setting != null) (0, _jquery2.default)('[name=options-popup-enable]').val([setting]);
	
	            setting = localStorage.getItem('options.showReserved.enable');
	            if (setting != null) (0, _jquery2.default)('[name=options-showReserved-enable]').val([setting]);
	
	            setting = localStorage.getItem('options.playsound.enable');
	            if (setting != null) (0, _jquery2.default)('[name=options-playsound-enable]').val([setting]);
	
	            setting = localStorage.getItem('options.playsound.volume');
	            if (setting != null) (0, _jquery2.default)('[name=options-playsound-volume]').val([setting]);
	
	            setting = localStorage.getItem('options.soundfile');
	            if (setting != null) (0, _jquery2.default)('#options-soundfile').val([setting]);
	
	            setting = localStorage.getItem('options.autoJump.enable');
	            if (setting != null) (0, _jquery2.default)('[name=options-autoJump-enable]').val([setting]);
	        }
	    }]);
	...
	var ResultMessage = function () {
	    ...
	    _createClass(ResultMessage, null, [{
	        ...
	        value: function show(mode) {
	            ...
	            (0, _jquery2.default)('#console').text(messages[mode]);
	            setTimeout(function () {
	                (0, _jquery2.default)('#console').text('');
	            }, 1000);
	        }
	    }]);
	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)("#options-soundfile").change(function () {
	        (0, _jquery2.default)("#options-soundfile option:selected").each(function () {
	            new Audio('../sound/' + (0, _jquery2.default)(this).val()).play();
	        });
	    });
	
	    (0, _jquery2.default)(document).on('click', '.btn-danger', function () {
	        var id = (0, _jquery2.default)(this).attr('data-id');
	        var type = (0, _jquery2.default)(this).attr('data-type');
	        var keys = {
	        ...
	        (0, _jquery2.default)(this).closest('.listgroup-item').remove();
	    });
	
	    (0, _jquery2.default)(document).on('click', '.soundtest', function () {
	        var soundfile = (0, _jquery2.default)('#options-soundfile :selected').val();
	        var volume = (0, _jquery2.default)("input[name=options-playsound-volume]").val();
	    ...
	    chrome.runtime.sendMessage({
	        ...
	        for (id in response) {
	            ...
	            (0, _jquery2.default)('.listgroup-program').append(_subscribe);
	        }
	    });
	    ...
	    chrome.runtime.sendMessage({
	        ...
	        for (id in response) {
	            ...
	            (0, _jquery2.default)(_subscribe2).find('.developer-app-name').attr({ href: 'http://com.nicovideo.jp/community/' + id });
	            (0, _jquery2.default)(_subscribe2).find('.list-group-text-block img').attr({ src: response[id]['thumbnail'] });
	            (0, _jquery2.default)(_subscribe2).find('.meta-description').html(response[id]['owner']);
	            (0, _jquery2.default)(_subscribe2).find('.btn-danger').attr('data-id', id);
	            (0, _jquery2.default)(_subscribe2).find('.btn-danger').attr('data-type', 'community');
	            // $(subscribe).find('.meta-description').html(response[id]['openDate'] + ' · Owned by <a href="' + response[id]['communityId'] + '">' + response[id]['communityName'] + '</a>');
	            (0, _jquery2.default)('.listgroup-community').append(_subscribe2);
	        }
	    });
	});
